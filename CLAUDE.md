...
- ❌ Nunca esconder a célula de um relatório sem dizer o que a ausência significa — no dashboard de saldos, mês sem lançamento aparece como "—" e **a soma das células visíveis deixa de bater com a linha de TOTAL**, que continua sendo o saldo REAL do bloco; isso é correto (é a diferença entre "o que andou" e "o que há"), mas só não vira defeito porque a dica do mouse e o cabeçalho explicam
